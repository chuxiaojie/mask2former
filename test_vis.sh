...
bash video_tracking/tools/dist_test.sh configs/mask2former/$1.py $NUM_GPU --checkpoint work_dirs/$1/iter_8000.pth --cfg-options model.track_head.pixel_decoder.encoder.layer_cfg.self_attn_cfg.im2col_step=1 val_dataloader.outfile_prefix=$1 test_evaluator.outfile_prefix=$1 model.init_cfg=None model.backbone.init_cfg=None test_cfg.fp16=true
